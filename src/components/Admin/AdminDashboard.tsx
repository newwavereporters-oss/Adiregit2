      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-30 px-4 sm:px-6 py-3 flex items-center justify-between shadow-2xs">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-700 text-xs font-bold transition-colors cursor-pointer"
          >
                      ...
                      <tr key={coupon.id} className="hover:bg-gray-50/80 transition-colors">
                        ...
                        <td className="p-4 text-right">
                          <button
                            ...
                            className="px-3 py-1 rounded-lg bg-gray-100 hover:bg-gray-200 text-xs font-bold text-gray-700 cursor-pointer"
                          >
                  ...
                  <tbody className="divide-y divide-gray-100 font-medium text-[#1A1A1A]">
                    {filteredLeads.map((lead) => (
                      <tr key={lead.id} className="hover:bg-gray-50/80 transition-colors">
                        ...
                        <td className="p-4 text-gray-600">{lead.whatsappNumber}</td>
